...
<p class="bg-primary">{{session('create_slider')}}</p>
...
<div class="col-sm-6">
    ...
    <div class="form-group">
        {!! Form::submit('Upload Slider',['class' => 'btn btn-primary'])!!}
...
<div class="col-sm-6">
    <table class="table">
        ...
        @if($photos)  
            ...
            {!! Form::open(['method'=>'POST','action'=>'AdminSliderController@updateslider','class'=>'form-inline'])!!}
        ...
        @foreach($photos as $photo)
            <tr>
                ...
                <td><input type="checkbox" name="id[]" value="{{ $photo->id }}" {{ $photo->is_active === 1 ? "checked=checked" : "" }}></td>
                <td>{{$photo->id}}</td>
                ...
                <td>
                    ...
                    <div class="form-group">
                        <div class="btn bg-danger"><a href="/admin/delete/slider/{{$photo->id}}">delete</a></div>
